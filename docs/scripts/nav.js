const contactInfo = `<div id="contact-modal">
	...
	<div class="modal-card Email" onclick="copyToClipboard('asadillahunty@gmail.com');">
		<a href="mailto:asadillahunty@gmail.com" target="_blank">
			<img src="images/gmail.svg" alt="E-mail"></svg></a>
...
function setUp() {
  ...
  document
    .getElementsByClassName("modal-bg")[0]
    .setAttribute("onClick", `closeModal("${modal_id}");`);

  // selecting "Contact Me" button here provides issues when not in a specific order
  nav.children[0].children[nav.children[0].children.length - 1].onclick =
    function (event) {
